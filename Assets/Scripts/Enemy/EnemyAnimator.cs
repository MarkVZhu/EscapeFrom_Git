...
public class EnemyAnimator : MonoBehaviour
{
    ...
    private void SetAnimatorState()
    {
        if (enemyComponent != null && enemyAnimator != null)
        {
            ...
            {
                if (this.GetComponentInChildren<WaypointMover>())
                {
                    if (this.GetComponentInChildren<WaypointMover>().waypoints.Count > 2 && this.GetComponentInChildren<WaypointMover>().isHorizon)
